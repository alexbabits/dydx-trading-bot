    ...
    ttk::style theme create sun-valley-dark -parent clam -settings {
        proc load_images {imgdir} {
            ...
            foreach file [glob -directory $imgdir *.svg] {
                ...
                [image create photo -file $file -format svg]
            }
        }
        ...
        # Scrollbar
        ttk::style element create Horizontal.Scrollbar.trough image $images(scroll-trough-hor) -sticky ew -border 6
        ttk::style element create Horizontal.Scrollbar.thumb image $images(scroll-thumb-hor) -sticky ew -border 3

        ttk::style element create Horizontal.Scrollbar.rightarrow image $images(scroll-right) -sticky {} -width 8
        ttk::style element create Horizontal.Scrollbar.leftarrow image $images(scroll-left) -sticky {} -width 8

        ttk::style element create Vertical.Scrollbar.trough image $images(scroll-trough-vert) -sticky ns -border 6
        ttk::style element create Vertical.Scrollbar.thumb image $images(scroll-thumb-vert) -sticky ns -border 3

        ttk::style element create Vertical.Scrollbar.uparrow image $images(scroll-up) -sticky {} -height 8
        ttk::style element create Vertical.Scrollbar.downarrow image $images(scroll-down) -sticky {} -height 8
